...
class CreativeLoginForm {
    ...
    const username = "Mahadev123";
    const password = "123456";

    if (this.emailInput.value.trim() !== username || this.passwordInput.value.trim() !== password) {
    ...
    try {
        ...
        this.showError('password', 'Login failed. Try again!');
    } finally {
    ...
    setTimeout(() => {
        window.location.href = "admin.html"; // apna target page yaha likho
    }, 3500); // 3.5 sec baad redirect
}
